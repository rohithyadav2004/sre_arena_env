"""Build HuggingFace Dataset from defender rollout observations."""
...
try:
    from ..models import DefenderObservation
    from .prompts import build_defender_prompt
except ImportError:
    from models import DefenderObservation
    from training.prompts import build_defender_prompt
